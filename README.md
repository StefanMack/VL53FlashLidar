...
Der TOF-Sensor VL53L1X von ST Micro (st.com) misst Abstände mit dem Lichtlaufzeitverfahren. Dabei wird ähnlich wie beim Ultraschallverfahren über die Echolaufzeit („Time Of Flight“ = TOF) der Abstand eines Objekts bestimmt, welches das Echo erzeugt hat.
...
In einem Applikationsvideo (youtube.com/watch?v=J_4giQJt7WI) von ST Micro wird ein Flash Lidar vorgestellt, der aus 9 VL53L1X Sensoren aufgebaut ist und damit einen Scanbereich von 180° überwacht. Jeder Einzelsensor davon überwacht ein Winkelsegment von ca. 20°.
